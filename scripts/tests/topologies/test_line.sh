...
if [ $1 -eq '1' ]; then
    ...
    iperf3 -c 10.10.10.3 -t $test_duration_s -p 5201 -u > ../docs/logs/iperf-log-latest.txt
    #pids+=($!)
...
if [ $1 -eq '3' ]; then
    ...
    iperf3 -c 10.10.10.1 -t $test_duration_s -p 5201 -u > ../docs/logs/iperf-log-latest.txt
