...
if [ $1 -eq '1' ]; then
    ...
    iperf3 -c 10.10.10.4 -t $test_duration_s -p 5201 -u -b 2M &
    pids+=($!)
        
    iperf3 -c 10.10.10.5 -t $test_duration_s -p 5201 -u -b 2M &
    pids+=($!)

    iperf3 -c 10.10.10.6 -t $test_duration_s -p 5201 -u -b 3M &
    pids+=($!)
...
if [ $1 -eq '4' ]; then
    ...
    #sleep $initial_offset_s
    iperf3 -c 10.10.10.2 -t $test_duration_s -p 520$1 -b 1M -u > ../docs/logs/iperf-log-latest.txt
...
if [ $1 -eq '6' ]; then
    ...
    #sleep $initial_offset_s
    iperf3 -c 10.10.10.3 -t $test_duration_s -p 520$1 -b 1M -u > ../docs/logs/iperf-log-latest.txt
